...
export class VisualFBMSimplex extends VisualLayer {
	static readonly TYPE = 'FBM (Simplex)';
	readonly type = VisualFBMSimplex.TYPE;
	...
	constructor(
		...
		super(name);
		this.scale = new VisualSliderNumber(scale, `${this.id}-scale`, 0, 5, 0.001);
		this.height =
